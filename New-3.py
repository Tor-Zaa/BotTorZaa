...
=======================
        !CommandMember!
=>Creator = ผู้สร้าง Bot
=>Gcreator = ตรวจสอบผู้สร้างกลุ่ม

        !Command Creator!
=>[Admin add @] = เพิ่ม Admin
=>[Admin remove @] = ลบ Admin
=>[Adminlist] = เช็ค Admin
=======================
☫[Help]
☫[Mybot]
☫[Me]
...
admin = ["ue4ade59a1ac5def03dafa1381fac6685","u2024cc459a51aebc3c016b2b2a64aba1","u73bfd086d60e582c21c1e3a19eaa2e2a","u02de3cd78fdc0af0d33f28bdc8d7275c"]
creator=["ue4ade59a1ac5def03dafa1381fac6685"]
wait = {
    'contact':False,
    'autoJoin':True,
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "ue4ade59a1ac5def03dafa1381fac6685":
                    if "join:" in msg.text:
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
               ...
               'MSGTPL': '5'}
                msg.text = None
        	cl.sendMessage(msg)    
      	    elif msg.text in ["æ„�1�7�ã®ãƒ�1�7�ãƒ¬ã�1�7�¼ãƒ³ãƒ˄1�7","Gift2"]:
                msg.contentType = 9
                msg.contentMetadata={'PRDID': 'a0768339-c2d3-4189-9653-2909e9bb6f58',
                'PRDTYPE': 'THEME',
                'MSGTPL': '6'}
...
#-----------------------------------------------
                ...
                if msg.from_ in creator:
                    ...
                    if targets == []:
                        ki.sendText(msg.to,"ไม่พบที่อยู่ติดต่อ")
                    else:
              ...
              if msg.from_ in creator:
                ...
                if len(string.decode('utf-8')) <= 20:
                    ...
                    cl.sendText(msg.to,"เปลี่ยนชื่อแล้ว " + string + "")
                ...
                if len(string.decode('utf-8')) <= 500:
                    ...
                    cl.sendText(msg.to,"Bio เปลี่ยนเป็น " + string + "")
                if msg.text in ["Read","read"]:
                    sendMessage(msg.to, "ฉันได้ตั้งจุดอ่าน♪ \ n 「check」จะแสดงคนที่อ่าน ♪")
                    try:
...
#---------------------------------------------------------
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Cancel Protection already on")
            elif msg.text.lower() in ["Auto join on","auto join on"]:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
            ...
            elif msg.text.lower() in ["Auto join off","auto join off"]:
...
#-----------------------------------------------
#-----------------------------------------------
            elif msg.text in ["Tagall","tagall","Tag","tag"]:
              if msg.from_ in admin:
                group = cl.getGroup(msg.to)
